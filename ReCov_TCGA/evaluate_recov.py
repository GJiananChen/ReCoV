...
if EXCLUSION:
    ...
    string_add = ""
args.results_dir = os.path.join(args.results_dir, args.which_splits, args.param_code, str(args.exp_code) + '_s{}'.format(args.seed) + time.strftime("_%d%b_%H_%M", time.gmtime()) + string_add)
if not os.path.isdir(args.results_dir):
...
# MEMORY_PATH = "/localdisk3/ramanav/Results/TCGA_Results/Recov/5foldcv/TransMIL_nll_surv_a0.0_5foldcv_gc32/tcga_brca_TransMIL_nll_surv_a0.0_5foldcv_gc32_s1_02Oct_16_15/tcgabrca_recov_results/memory_TCGA_cindex_1auc_0.5_0_nosplit.npy"
