...
if __name__ == '__main__':
    ...
    parser.add_argument("--noisy",default="aggre",type=str,help="choose from ['clean', 'random1', 'random2', 'random3', 'aggre', 'worst']")
    ...
    # with open(str(file_loc / f"results/memory_cifar_{NOISE_TYPE}_{TAU}_{FEAT}_{N_RUNS}_v2.npy"), "wb") as file:
