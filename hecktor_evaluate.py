...
def train(epoch, train_loader):
    ...
    # [16, 87, 135, 150, 180, 262, 269, 303, 365, 370, 372]
    ...
    # exclusion = []
    # exclusion = [324,  72,  12, 345, 135, 316, 208,  40,  10, 149,  58,   6, 257,173, 270]
    # exclusion = [111 , 34 ,173 , 79, 215, 140, 283, 153 ,317 , 58 ,378  ,10 ,270  ,54 ,249 ,316 ,332 ,266, 149, 269]
    exclusion = [135 , 72 , 21, 173 ,111 ,266, 316 ,257 ,249 , 76 ,58 , 40 , 13 ,200, 113 ,  6 , 54 , 79 ,294, 180]
