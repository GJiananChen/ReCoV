...
DATA = '/aippmdata/public/PANDAS/train_images'
TEST = '/aippmdata/public/PANDAS/train.csv'
sz = 224
nworkers = 4
...
MPP = 1
# MPP = 0.5
OUTPUT_DIR = Path(f'/localdisk3/ramanav/TCGA_processed/PANDAS_MIL_Patches_Selfpipeline_{MPP}MPP')
